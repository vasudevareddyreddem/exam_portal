   ...
   <body>
      <div class="header">
         <div class="container">
            <div class="row">
               <div class="col-lg-1">
                  <img style="width:80px;height:auto;" src="image/logo.png" alt="logo" >
               </div>
               <div class="col-lg-4">
                  <span class="logo">Be a Millionaire</span>
               </div>
               <div class="col-md-2 col-md-offset-4">
                  <a href="#" class="pull-right btn sub1" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Log In</b></span></a>
               </div>
               <!--sign in modal start-->

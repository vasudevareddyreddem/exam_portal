...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Millionaire</b></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Exam Name</a></li>
...
if($rowcount == 0){
	echo '&nbsp &nbsp <tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
...
echo'<br /><button type="submit"style="position:relative;left:40px;" class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true" ></span>&nbsp;Next</button>' ; 
echo' <br /><button type="submit" style="position:relative;left:200px; margin-top:-55px;"class="btn btn-primary"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span>&nbsp;Submit</button></form></div>';
...
echo  '<div class="panel title">
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b></b></td><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
...
<input type="submit" name="daily" value="Number of days" onclick="myDate()" style="margin-top:120px;"class="btn btn-primary" />
<?php
...
<div class="form-group" align="center">
<a href="today score.php"><input type="submit" name="today score" value="Today Score"  style="margin-top:30px;"class="btn btn-primary" /></a>
</div>

<div class="form-group" align="center">
<a href="total score.php"><input type="submit" name="totalscore" value="Total Score" style="margin-top:30px;"class="btn btn-primary" />
</div>

<div class="form-group" align="center">
<input type="submit" name="daily" value="Daily Quest" onclick="myfun1()" style="margin-top:30px;"class="btn btn-primary" />
<script>
function myfun1()
{
	alert("my daily quest");
}
</script>
</div>

<div class="form-group" align="center">
<input type="submit" name="news" value="What New's" onclick="myfun2()" style="margin-top:30px;" class="btn btn-primary" />
<script>
function myfun2()
{
	alert("what's news");
...
<div class="form-group" align="center">
<a href="subscribe.php"><input type="submit" name="payment"  style="margin-top:30px;" value="Subscribe"  class="btn btn-primary" /></a>
</div>
</div>
</div>
</div>

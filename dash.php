  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="dash.php?q=2">Score</a></li>
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b></b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
<div class="row">
  ...
  <div class="col-md-6"> 
    <input  type="submit" style="position:relative;left:-180px;padding: 5px 25px;" value="Next" class="btn btn-primary"/>
  </div>

<label class="col-md-6 control-label" for=""></label>
  <div class="col-md-6"> 
    <input  type="submit"style="position:relative;top:-30px;padding: 5px 20px;" value="Submit" class="btn btn-primary"/>
  </div>
</div>
</div>

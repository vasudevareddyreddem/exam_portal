...
<div style="padding:0px;margin:0px auto;width:600px;border:1px #e7e7e7 solid">
			<div style="background:#ddd repeat-x;height:100px">
				...
				<img style="width:100px;height:auto" src="<?php echo base_url(); ?>assets/vendor/image/logo.png" class=""> 
				</div>
			</div>
			<div>
				...
				<p style="text-align:left">Dear <?php echo isset($details['name'])?$details['name']:'';?>,</p>
							<p><strong>Greetings from <?php echo base_url(); ?>! <img goomoji="263a" data-goomoji="263a" style="margin:0 0.2ex;vertical-align:middle;max-height:24px" alt="☺" src="https://mail.google.com/mail/e/263a" class="CToWUd"></strong></p>
						<table id="customers">
						  <tr>
							<th>Your Password</th>
